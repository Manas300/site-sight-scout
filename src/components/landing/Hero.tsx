    ...
    <section className="relative pt-32 pb-12 md:pb-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        <div className="animate-fade-in">
          ...
          {/* LOI Goal Box */}
          <div className="max-w-3xl mx-auto mb-8 px-4 md:px-6 py-4 bg-gradient-to-r from-warning/20 via-primary/20 to-secondary/20 border-4 border-warning rounded-xl text-center animate-pulse">
