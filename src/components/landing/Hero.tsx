        ...
        <div className="animate-fade-in">
          ...
          <div id="limited-spots" className="mb-6 sm:mb-8 px-4 sm:px-6 md:px-8 py-4 sm:py-5 bg-gradient-to-r from-primary/20 to-secondary/20 border-2 border-primary rounded-lg max-w-2xl mx-auto text-center animate-pulse">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-base sm:text-lg md:text-xl font-black text-destructive uppercase tracking-wider">⚠️ ONLY 1,200 SPOTS ⚠️</p>
          ...
          {/* FOMO Counter */}
          <div className="mb-12 grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 max-w-2xl mx-auto">
            <div className="px-4 sm:px-6 md:px-8 py-4 sm:py-5 bg-destructive/20 border-2 border-destructive rounded-lg text-center">
              ...
              <p className="text-xs sm:text-sm text-destructive/80 font-bold mt-1">BETA SPOTS LEFT</p>
            </div>
