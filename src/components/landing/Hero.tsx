      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <h1 className="text-4xl md:text-8xl font-black tracking-tighter mb-6 leading-none">
            ...
            <span className="block text-secondary animate-pulse tracking-normal" style={{ animationDelay: '0.3s' }}>START BIDDING <span style={{ letterSpacing: '-0.02em' }}>WA</span>RS.</span>
