    ...
    <section className="relative pt-32 pb-12 md:pb-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        <div className="animate-fade-in">
            ...
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <div className="space-y-3 p-4 bg-primary/10 border-l-4 border-primary rounded-r-lg">
                  ...
                  <p className="text-sm md:text-lg font-semibold text-secondary leading-relaxed animate-pulse" style={{ fontFamily: 'Poppins, sans-serif', textShadow: '0 0 20px hsl(var(--secondary) / 0.5), 0 0 40px hsl(var(--secondary) / 0.3)' }}>
                    We're raising $850K now for 18 months of cash burn — and your LOI helps prove real demand to investors.
                  </p>
          ...
          {/* LOI Goal Box */}
          <div className="max-w-4xl mx-auto mb-8 px-4 md:px-8 py-5 bg-gradient-to-r from-warning/20 via-primary/20 to-secondary/20 border-4 border-warning rounded-xl text-center animate-pulse">
            <p className="text-2xl sm:text-3xl md:text-5xl font-black text-warning whitespace-nowrap">
              🎯 NEXT LOI GOAL: 500 🚀
            </p>
          </div>
