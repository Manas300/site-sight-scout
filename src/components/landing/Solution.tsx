...
export const Solution = () => {
  const solutions = [
    ...
    },
    {
      ...
      impact: "No more shouting into the void. Your family grows with every stream."
    },
    {
      emoji: "💰",
      ...
      impact: "Promote your latest pack, loop, or non-exclusive beat live with a one-click Buy Now button."
    },
    {
      emoji: "🎯",
