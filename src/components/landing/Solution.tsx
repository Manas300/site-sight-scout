  ...
  const solutions = [
    {
      ...
      impact: "You set the price. You are the hype. Your beats become monetizable events."
    },
    {
      emoji: "📈",
      title: "BUILD YOUR AUDIENCE IN REAL TIME.",
      solution: <><span className="font-bold">Fans watch, tip, and share your cook-ups in real-time. You become visible.</span></>,
