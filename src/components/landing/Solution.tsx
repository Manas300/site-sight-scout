...
export const Solution = () => {
  const solutions = [
    ...
    },
    {
      ...
      solution: <><span className="font-bold">BAGR gives you an entire beat business you can run from your back pocket — powered by live shopping. Because when it's live, demand explodes.</span></>,
