...
export const PainPoints = () => {
  const pains = [
    ...
    },
    {
      ...
      pain: <><span className="font-bold">You're drowning in a sea of 10 million producers on IG. Your beats? Buried by the meme-hungry algorithm. No redirects to your beat store = no sales.</span></>,
    ...
    },
    {
      ...
      pain: <><span className="font-bold">Those Discord servers are just loop farms.             Big-name producers dangle placements to milk your talent for free, draining your best ideas.</span></>,
