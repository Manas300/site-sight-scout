...
export const PainPoints = () => {
  const pains = [
    ...
    },
    {
      ...
      pain: <><span className="font-bold">You're drowning in a sea of 10 million producers on IG. Your beats? Buried under all the memes. No redirects to your beat store means no sales.</span></>,
