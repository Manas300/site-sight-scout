...
export const PainPoints = () => {
  const pains = [
    ...
    },
    {
      ...
      pain: "You're drowning in a sea of 10 million producers on IG. Your beats? Buried in the algorithm. Zero redirects to your beat store. No views. No sales.",
    ...
    },
    {
      ...
      pain: "Those Discord servers are just loop farms — big-name producers dangle \"placements\" to milk your talent for free, draining your best ideas. Wake up.",
